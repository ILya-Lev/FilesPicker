...
namespace FolderParser
{
	...
	public partial class MainWindow : Window
	{
		...
		public MainWindow()
		{
			...
			m_parser = new Parser(m_progressToken);
			m_treeFiller = new TreeFiller(m_treeView, m_progressToken);
			m_xmlFiller = new XMLFiller(m_progressToken);
		...
		private void StartButton_OnClick(object sender, RoutedEventArgs e)
		{
			try
			{
				...
				m_treeFiller.CleanData();
				m_xmlFiller.CleanData();
		...
		private void ParserFinishEventHandler(object sender, string message)
		{
			lock (m_errorMessages)
			{
				m_progressToken.InProgress = false;		//was inside dispatcher.invoke method
