...
namespace FolderParser
{
	class XMLFiller : Filler, INotifyPropertyChanged
	{
		...
		public XMLFiller(ProgresStateSynchronizer inProgress, CountdownEvent folderEndSynch, CountdownEvent fileEndByXML)
			: base(inProgress, folderEndSynch, fileEndByXML)
		{
			OutputFileName = "folderStructure.xml";
			m_threadName = "XML thread";
		}
